...
const Slide:FC<ISlide> = ({image, link, handleClickNext, handleClickPrev}) => {
    ...
    return (
        <section className={`relative w-full`}>
            ...
            <div className={`absolute bottom-14 left-14 flex items-center w-64`}>
                <Link href={link} className={`py-4 px-5 rounded-xl bg-[#fff] mr-9 text-xs lg:text-basis`}>Подробнее</Link>
